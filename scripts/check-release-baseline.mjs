...
const checks = {
  ...
  rankTrackingCompactActionColumn: [adminSource, clientSource].every((source) => source.includes("mi-rank-track-main")
    ...
    && source.includes("grid-template-columns: 88px minmax(78px, 0.48fr) minmax(132px, 0.68fr) minmax(136px, 0.66fr) minmax(96px, 1fr)")
    && source.includes("grid-template-columns: minmax(100px, 0.55fr) minmax(132px, 0.72fr) minmax(136px, 0.7fr) minmax(0, 1.4fr)")
