...
-- Runtime 1.1.8 adds stable full-window cross-page proof without relaxing
-- absolute ranks, ad exclusion, checkedCount 300, or fail-closed submission.
...
begin
  if p_run_id is null
    ...
    or trim(coalesce(p_runtime_version, '')) <> '1.1.8'
...
begin
  ...
  return jsonb_build_object(
    ...
    'candidate_eligible', coalesce((current_row.circuit_state = 'closed'
      ...
      and current_row.runtime_version = '1.1.8'
