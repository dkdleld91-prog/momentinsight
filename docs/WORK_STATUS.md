...
- 대상 63/63, 전체 API·서버 373/373, 플레이스 51/51, 쇼핑 51/51, 서버 계약 37/37, Production 인증 18/18, 보호 잠금 22함수·54파일·12마이그레이션, LaunchAgent plist·exit 0과 전체 `npm run check:release`를 통과했다. Production 배포는 대표님 승인에 따라 진행한다.
