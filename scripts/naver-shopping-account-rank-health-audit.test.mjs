...
test("builds one fixed-time fail-closed account audit without exposing lease tokens", () => {
  ...
  assert.equal(N30_ACCOUNT_HEALTH_RUNTIME_VERSION, "1.1.32");
  ...
  try {
    await database.exec(`
      ...
      insert into naver_shopping_worker_runs(
        ...
        ('${runIds[0]}', 'windows-desktop-primary', 'rank-catch-up', '1.1.32',
          '${N30_ACCOUNT_HEALTH_RUNTIME_FINGERPRINT}', '2026-08-29T12:03:30Z'),
        ('${runIds[1]}', 'windows-desktop-primary', 'rank-catch-up', '1.1.32',
          '${N30_ACCOUNT_HEALTH_RUNTIME_FINGERPRINT}', '2026-08-29T12:05:30Z'),
        ('${runIds[2]}', 'windows-desktop-primary', 'rank-catch-up', '1.1.32',
      ...
      insert into naver_shopping_worker_coordination(
        ...
        null, '1.1.32', '${N30_ACCOUNT_HEALTH_RUNTIME_FINGERPRINT}',
