-- Runtime 1.1.15 keeps stable-finite-window-v1 as the sanitized database
...
begin
  ...
  if coordination_found is not true
    ...
    or target.runtime_fingerprint is distinct from '13e801cf18adaea7352d7c78bbe067f969e3fef5e756528335443d3122b2d405'
    ...
    raise exception 'naver_shopping_runtime_1_1_15_requires_idle_control_plane';
  end if;
end
$migration_guard$;
...
begin
  ...
  if target_updated_count <> 1 then
    raise exception 'naver_shopping_runtime_1_1_15_target_mismatch';
  end if;
end
$target_transition$;
...
begin
  ...
  if not found
    or target.runtime_version is distinct from '1.1.15'
...
begin
  ...
  eligible := coalesce((
    ...
    and target.runtime_version = '1.1.15'
