...
const checks = {
  ...
  shoppingRemoteWakeIsAtomicAndOneJobBounded: shoppingChromeManifest.version === "1.1.18"
    ...
    && shoppingLocalWorker.includes('const EXPECTED_RUNTIME_VERSION = "1.1.18";')
    && shoppingLocalWorkerHandler.includes('const EXPECTED_WORKER_RUNTIME_VERSION = "1.1.18";')
    && rankServer.includes('const SHOPPING_WORKER_EXPECTED_RUNTIME_VERSION = "1.1.18";')
  ...
  shoppingRuntime1116ExactParentProofExactIdentity:
    ...
    && shoppingCandidatePerformanceAudit.includes('export const N30_TARGET_RUNTIME_VERSION = "1.1.18";')
  ...
  shoppingManualExtensionQueuesEntireTrackerSite: shoppingChromeManifest.version === "1.1.18"
    && shoppingChromeWorker.includes('port.postMessage({ action: "run", trigger, ...runtimeIdentity })')
