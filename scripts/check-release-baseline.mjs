...
const checks = {
  ...
  shoppingNormalChromeBridgeIsLeastPrivilegeAndAtomic: JSON.stringify(shoppingChromeManifest.permissions) === JSON.stringify([
    ...
    && shoppingChromeWorker.includes("location.assign(anchor.href)")
  ...
  shoppingRemoteWakeIsAtomicAndOneJobBounded: shoppingChromeManifest.version === "1.0.30"
  ...
  shoppingManualExtensionQueuesEntireTrackerSite: shoppingChromeManifest.version === "1.0.30"
