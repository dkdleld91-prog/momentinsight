...
- provenance RED는 migration 표 부재, local/native/server의 unknown trigger 거부 부재, progress RPC의 `p_run_trigger` 부재로 5건 실패했습니다. 최소 구현 뒤 Chrome/native/local/cloud/server/DB의 allowlist와 signed 전달, `navigating`에서만 append, 같은 run 불일치 rollback 회귀가 GREEN했습니다.
- 독립 migration 감사에서 coordination row lock 뒤 constraint DDL이 강한 table lock으로 승격되는 lock-order P1을 발견했습니다. 회귀는 `lock_timeout=5s`와 row lock보다 앞선 `ACCESS EXCLUSIVE`가 없을 때 RED였고, 둘을 migration transaction 첫 단계에 배치한 뒤 GREEN 및 재감사 P0/P1 없음입니다. 잠금 획득 실패는 5초 안에 전체 rollback이며 반복 적용으로 우회하지 않습니다.
- 최종 실행 결과: N30 집중 `340/340 PASS`, `check-server-contract 71/71 PASS`, `check-release-baseline PASS`, 보호 lock `23 functions / 102 files / 50 migrations PASS` 및 self-test PASS, `git diff --check PASS`입니다. 전체 `npm run check:release`도 core `1071/1071`, Place `51/51`, Shopping `64/64`, Production auth `18/18`, public build 10파일·inline 6·CSP hash 4로 exit0입니다. 이 값은 로컬 배포 후보 검증이고, 별도의 실제 Production·DB·Windows 증거는 바로 아래 항목에 기록했습니다.
...
- 첫 `rank-catch-up` run `c9e710c8-5fe8-4ad8-a25b-267154459334`은 event9977→9979, collection `pw-chrome-1787594315521-45c224f25432e87ddfc1`로 terminal됐습니다. provenance worker/runtime/fingerprint가 exact이고 group/tracker/commit 각1·failure0입니다. snapshot1은 checked300·official collector·matched=false·organic policy/evidence·adExcluded true·excluded30·top5 organic/non-ad 위반0입니다. DB stability anchor는 `2026-08-24T17:58:36.220664Z`입니다.
- 뒤이어 remote run `d73592f3-ed34-47c5-9b13-b36fd46a174d`과 catch-up `bddab480…`·`364f86f8…`도 각각 group1·tracker1·commit1·failure0·valid atomic snapshot으로 끝났습니다. `18:26:33.870513Z` 집계는 provenance4, commits4, invalid commit/snapshot0, same-cycle group duplicate0, groups-per-run violation0, cursor regression0, overlap0, total integrity violation0입니다. remote1은 향후 scheduled 성능에서 제외합니다.
- residual target `1114f3af-c30c-4975-9b79-ecec9cfbf031`의 자연 재진입 run `34ae471b-0f9a-4d4a-a9ad-0883ed24cf3a`은 event9993→9996에서 `provider_partial_window:30_300` typed failure와 24시간 quarantine로 종료됐습니다. post-claim snapshot0, 기존 snapshot_count58·last_checked_at·rank/check_count/found_count 불변을 대조해 부분 저장과 이력 오염이 없음을 확인했습니다. 이 회차는 atomic300 성공으로 세지 않습니다.
- 다음 grouped run `28ce3a7a-072d-4fde-9ada-cdbcb290cd2c`은 group1·tracker2·commit2·failure0, collection `pw-chrome-1787597316296-b8e372f9400fb925490c` 1개, valid atomic snapshot2/2입니다. `2026-08-24T18:55:01.913113Z` SELECT-only 값은 provenance6(catch-up5·remote1), same-cycle duplicate0·overlap0, streak5·anchor `2026-08-24T17:58:36.220664Z` 유지, baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다. earliest candidate는 `2026-08-25T17:58:36.220664Z` 이후이고 성공6회도 아직 false이며 setter·wake/cursor/order/quarantine/lease 변경0입니다.
- `2026-08-24T19:26:48.081245Z` 재감사는 provenance10(catch-up8·remote2)·identity mismatch0입니다. event10084 이후 4개 run은 group1·fully terminal이며 commit6개와 matching snapshot6개가 모두 checked300·official source·organic-only/evidence·adExcluded·collection 일치·top-item 위반0, invalid atomic0입니다. catch-up claim gap은 600·600·600초, open/incomplete0·same-cycle duplicate0·overlap0입니다. operations는 streak9·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다. 성공6회 gate는 충족했지만 anchor+24시간은 미충족이라 candidate_eligible=false이고 setter/상태 DML은0회입니다.
- `2026-08-24T19:55:58.933147Z` 추가 표본은 run `28bca4cc…`·`f008b925…`·`4e542b0b…`이며 각 group1·tracker1·commit1·failure0, commit/snapshot3/3 valid atomic300, catch-up gap600·600·600초입니다. 누적 provenance13(catch-up11·remote2)·identity mismatch0, streak12, open/incomplete·same-cycle duplicate·overlap0이고 anchor24h만 false입니다. baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle, setter/상태 DML0을 유지했습니다.
- `2026-08-24T20:26:17.449412Z` 추가 표본은 catch-up `6dcc0969…`·`1b017c50…`·`2d9fc83…`와 remote `f279d190…`입니다. group4·tracker/commit5·failure0, matching snapshot5/5가 checked300·official source·organic-only/evidence·adExcluded·collection 일치·top-item 위반0입니다. catch-up gap600·600·600초, cursor strict-forward4/4, invalid/open/incomplete·same-cycle duplicate·overlap0입니다. 누적 provenance17(catch-up14·remote3)·identity mismatch0, streak16·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T20:56:17.731412Z` 추가 catch-up은 `f9710be7…`·`4daf8f29…`·`24cf809a…`이고 group/tracker/commit 각3·failure0, matching snapshot3/3 valid atomic300입니다. gap600·600·600초·cursor strict-forward3/3, invalid/open/incomplete·same-cycle duplicate·overlap0입니다. 누적 provenance20(catch-up17·remote3)·identity mismatch0, streak19·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T21:26:44.446527Z` 추가 표본은 catch-up `fdaaed09…`·`1ea9e89f…`·`aca53285…`와 remote `50abe232…`입니다. group4·tracker/commit8·failure0, matching snapshot8/8 valid atomic300입니다. catch-up gap600·600·600초·cursor strict-forward4/4, invalid/open/incomplete·same-cycle duplicate·overlap0입니다. 누적 provenance24(catch-up20·remote4)·identity mismatch0, streak23·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T21:56:50.815466Z` 추가 catch-up은 `d6b92329…`·`8854ae49…`·`7477fe68…`이고 group3·tracker/commit7·failure0, matching snapshot7/7 valid atomic300입니다. gap600·601·600초·cursor strict-forward3/3, invalid/open/incomplete·same-cycle duplicate·overlap0입니다. 누적 provenance27(catch-up23·remote4)·identity mismatch0, streak26·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T22:27:14.864925Z` 추가 표본은 remote `dbacc97c…`와 catch-up `28ac3f50…`·`f3f35128…`·`ac8dd03e…`입니다. group4·tracker/commit5·failure0, matching snapshot5/5 valid atomic300, cursor strict-forward4/4, invalid/open/incomplete·same-cycle duplicate·overlap0입니다. 동시대 remote가 사이에 있는 catch-up gap은 645·554·600초이며 remote는 별도 제외합니다. 누적 provenance31(catch-up26·remote5)·identity mismatch0, streak30·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T23:00:58.818677Z` 표본은 catch-up4·remote1이며 최초 SELECT의 진행 중 remote를 terminal까지 관측했습니다. 최종 run5·commit/snapshot6/6 valid atomic300·open0, catch-up gap600·600·643초, cursor strict-forward5/5, invalid·same-cycle duplicate·overlap0입니다. 643초 구간에는 동시대 remote가 있어 별도 제외합니다. 누적 provenance36(catch-up30·remote6)·identity mismatch0, streak35·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T23:27:39.481349Z` 추가 catch-up은 `d443e67e…`·`1258a42e…`이고 group/tracker/commit 각2·failure0, matching snapshot2/2 valid atomic300입니다. gap600초·cursor strict-forward2/2, invalid/open·same-cycle duplicate·overlap0입니다. 누적 provenance38(catch-up32·remote6)·identity mismatch0, streak37·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다.
- `2026-08-24T23:58:53.748785Z` 추가 표본은 catch-up4·remote1입니다. 마지막 in-flight catch-up을 terminal까지 재조회해 최종 run5·tracker/commit5·failure0, matching snapshot5/5 valid atomic300·open0을 확인했습니다. catch-up gap600·600·600초·cursor strict-forward5/5, invalid·same-cycle duplicate·overlap0입니다. 누적 provenance43(catch-up36·remote7)·identity mismatch0, streak42·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이고 anchor24h만 false입니다.
- `2026-08-25T00:28:58.442450Z` 추가 표본은 rank-0900 `b9acbb1e…`와 catch-up `7c26501b…`·`819415f3…`·`3c86e12c…`입니다. group/tracker/commit 각4·failure0, matching snapshot4/4 valid atomic300, catch-up gap600·600초·cursor strict-forward4/4, invalid/open·same-cycle duplicate·overlap0입니다. provenance47(catch-up39·remote7·rank-0900 1)·identity mismatch0, streak46·anchor 유지·baseline10·candidate false·완전 idle이고 anchor24h만 false입니다. rank-0900은 candidate 성능 분자에서 별도 제외합니다.
- `2026-08-25T01:03:53.420824Z` 추가 표본은 remote `e723f088…`·`828a7b6f…`와 catch-up `27fe56a3…`·`b99185a4…`·`b6f3bd15…`입니다. group/tracker/commit 각5·failure0, matching snapshot5/5 valid atomic300, catch-up gap599·601·600초·cursor strict-forward5/5, invalid/open·same-cycle duplicate·overlap0입니다. provenance52(catch-up42·remote9·rank-0900 1)·identity mismatch0, streak51·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이고 anchor24h만 false입니다.
- `2026-08-25T02:02:24.809274Z` 추가 표본은 remote2·catch-up6, run8·group8·tracker/commit10·failure0입니다. matching snapshot10/10 valid atomic300, cursor violation·open·same-cycle duplicate·overlap0이며 catch-up gap은 600·600·600·600·648·552초입니다. 648·552초 구간의 동시대 remote는 분리합니다. provenance60(catch-up48·remote11·rank-0900 1)·identity mismatch0, streak59·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이고 anchor24h만 false입니다.
- `2026-08-25T02:32:57.490657Z` 표본에서 잔여 `12f5330a…`의 자연 재진입 run `41dbbe76…`은 event10352 group→10353 tracker→10354 `provider_partial_window:137_300`→10355 quarantine로 terminal됐습니다. post-claim snapshot0, snapshot_count71·latest_snapshot_at=`last_checked_at=2026-08-09T07:38:00.984Z`·rank1·check/found71 보존, processing null·quarantine `2026-08-26T02:10:35.927243Z`입니다. cycle37은 group58=distinct claim/fingerprint58·tracker74=distinct74·commit73·failure1로 event10356에서 완료됐고, cycle38 첫 grouped run은 tracker/commit/snapshot2/2 valid atomic300입니다. 이번 run4·group4·tracker5·commit4·failure1, 성공 atomic invalid0·open/overlap0입니다. provenance64(catch-up50·remote13·rank-0900 1)·identity mismatch0, streak62·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다.
- `2026-08-25T03:46:47.965329Z` 추가 표본은 cycle38 catch-up7·remote1, run8·group8·tracker/commit10·failure0입니다. matching snapshot10/10 valid atomic300, cursor violation·open·same-cycle duplicate·overlap0이고 catch-up gap은 601·599·600·600·600·600·600초입니다. provenance72(catch-up57·remote14·rank-0900 1)·identity mismatch0, streak70·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이고 anchor24h만 false입니다.
- `2026-08-25T03:59:26.931799Z` 추가 표본은 catch-up `337462b5…`·`e242e848…`와 remote `dd22786f…`입니다. event10480~10482·10485~10489·10491 이후에서 run3·group3·tracker/commit4·failure0이며 snapshot4/4가 success 함수와 동일한 matched=false 허용 조건을 포함해 checked300·official source·organic-only/rank evidence·adExcluded·excluded45·collection 일치·top-item organic/non-ad를 충족했습니다. 세 cursor tuple은 strict-forward, 실행 overlap0이고 cycle38 누적 group12=distinct claim/fingerprint12·tracker16=distinct16·commit16·failure/open0입니다. provenance74(catch-up58·remote15·rank-0900 1)·identity mismatch0, streak73·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이며 anchor24h만 false입니다.
- `2026-08-25T04:12:19.503480Z` 추가 표본 `0f8f27bb…`은 group/tracker/commit 각1·failure/open0, matching snapshot1/1 valid atomic300, excludedAdCount6, cursor strict-forward입니다. cycle38 누적 group13=distinct claim/fingerprint13·tracker17=distinct17·commit17·failure/open0이고 provenance75(catch-up59·remote15·rank-0900 1)·identity mismatch0, streak74·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다.
- `2026-08-25T04:19:38.180199Z` 추가 표본 `8e5cfb4f…`은 exact1.1.13 provenance `rank-catch-up`, event10499~10501 group/tracker/commit 각1·failure/open0입니다. collection `pw-chrome-1787631516118-3e527c89579336ecc8d1` snapshot1은 checked300·official source·organic policy/evidence·adExcluded·excluded60·collection 일치·top-item 위반0·rank1이고 cursor strict-forward입니다. cycle38 누적 group14=distinct claim/fingerprint14·tracker18=distinct claim/tracker18·commit18·failure/open/atomic invalid/중복0, anchor 이후 overlap0입니다. provenance76(catch-up60·remote15·rank-0900 1)·identity mismatch0·run당 group 위반0, streak75·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이며 anchor24h만 false입니다.
- `2026-08-25T04:24:02.817585Z` 추가 remote `bc87c1bc…`은 exact1.1.13 provenance `rank-remote`, event10503~10505 group/tracker/commit 각1·failure/open0입니다. collection `pw-chrome-1787631692481-adf9543e7d97efc659d7` snapshot1은 checked300·official source·organic policy/evidence·adExcluded·excluded45·collection 일치·top-item 위반0·rank95이고 cursor sort300→400 strict-forward입니다. cycle38 누적 group15=distinct claim/fingerprint15·tracker19=distinct tracker19·commit19·failure/open/중복0, provenance77(catch-up60·remote16·rank-0900 1)·identity mismatch0, streak76·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다. remote는 candidate 성능 분자에서 제외하며 anchor24h만 false입니다.
- `2026-08-25T04:30:28.258261Z` 추가 catch-up `e59a2f09…`은 page4 수집 중 상태를 별도 성공으로 세지 않고 event10508~10512 terminal까지 확인했습니다. group1·tracker/commit2·failure/open0, shared collection `pw-chrome-1787632158902-78ad9a91c1d8ed4fd567` snapshot2/2가 checked300·official source·organic policy/evidence·adExcluded·excluded30·collection 일치·top-item 위반0이며 rank237/미발견입니다. cursor는 sort400 내부 created_at strict-forward이고 cycle38 누적 group16=distinct claim/fingerprint16·tracker21=distinct tracker21·commit21·failure/open/중복0입니다. provenance78(catch-up61·remote16·rank-0900 1)·identity mismatch0, streak77·anchor 유지·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle이며 anchor24h만 false입니다.
- fixed observedAt `2026-08-25T04:36:17.584413Z`를 파라미터로 고정한 Production `BEGIN READ ONLY` correlated aggregate는 marker `n30_baseline10_fixed_wall_v1`, wall38261.363749초, provenance78(catch-up61·remote16·rank-0900 1), missing/identity mismatch0을 반환했습니다. catch-up61 중 fully-terminal atomic300은59, known `1114…`·`12f5…` typed failure2, bootstrap 제외58이며 fixed-wall `5.457202 group/hour`입니다. groups-per-run·tracker/commit duplicate·atomic invalid·open/incomplete·overlap·600초 배수±120 grid violation은 모두0입니다. mutable 현재시각·active duration·remote/정시/partial을 분자에 쓰지 않았고 candidate setter는 호출하지 않았습니다.
- `2026-08-25T04:42:26.246630Z` marker `n30_incremental_read_only_v1`은 새 exact catch-up `f9a01a99…`의 group1·tracker/commit4·failure0과 collection `pw-chrome-1787632717073-cb774775483104d5ba2e`를 반환했습니다. snapshot4/4는 checked300·official source·organic policy/evidence·adExcluded·excluded45·top-items5/위반0, ranks6/46/8/25입니다. 이전 cursor `74fb18e0…`→현재 `60864aa5…`는 같은 sort400 내부 created_at strict-forward이고 tracker processing/quarantine는 null입니다. cycle38 group17=distinct claim/fingerprint17·tracker/commit25=distinct tracker25·failure/open0, provenance79(catch-up62·remote16·rank-0900 1)·mismatch0, operations streak78·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다.
- `2026-08-25T04:49:38.782193Z` marker `n30_run_55dc17bc_terminal_v1`은 최초 page5 in-flight 표본을 성공으로 세지 않은 뒤 exact catch-up `55dc17bc…`의 group1·tracker/commit1·failure/open0을 terminal로 반환했습니다. collection `pw-chrome-1787633318002-4b336137ade998308749` snapshot1은 checked300·official source·organic policy/evidence·adExcluded·excluded45·top-items5/위반0·rank157이고 cursor tuple은 sort400→500 strict-forward입니다. cycle38 group18=distinct claim/fingerprint18·tracker/commit26=distinct tracker26·failure/open0, provenance80(catch-up63·remote16·rank-0900 1)·mismatch0, operations streak79·baseline10·candidate false·fresh heartbeat·closed/null·processing0·완전 idle입니다.
- `scripts/naver-shopping-candidate-performance-audit.test.mjs`는 생성기 부재, global integrity, pinned identity, fixed-window cursor 계약의 RED를 거쳐 GREEN 4/4가 됐고 `node --test --experimental-test-coverage`에서 line/branch/function 100%입니다. 이 파일을 `npm test` 기본 회귀에도 포함했습니다. 생성 SQL은 `BEGIN READ ONLY`·repeatable read, 고정 activation/observed, exact provenance, claim-correlated membership/order, atomic300 official organic/adExcluded, post-bootstrap18, 첫 catch-up phase 기준 360초 gap grid±120, fixed-wall120분·`>8.77`, 전 exact run failure/중복/open/overlap/control-plane idle 및 `candidate_success`를 포함하며 setter·DML·`now()`류는 정적 부재입니다.
- 새 marker `n30_candidate_performance_audit_v1`의 Production 고정 baseline 재현은 wall38261.363749초·provenance78(catch-up61·remote16·rank-0900 1)·mismatch0·valid atomic59·known failure2·post-bootstrap58·5.457202 group/hour입니다. claim/commit membership·event order·atomic invalid·run당 group·중복·open·overlap·grid·cycle identity missing은0이고 global failure2·collection-count violation2는 두 typed failure를 정확히 fail-closed했습니다. malformed/NULL-reset cursor 증거는0, `cursor_nonforward_or_fallback_count=2`는 event9993 `1114…`(cursor3700→sort600)와 event10352 `12f5…`(cursor3700→sort100)입니다. ledger에 seed/selectionMode가 없어 strict seed-order 완전 증명은 불가능하며 합법 grouped sibling/fallback도 이 보수 gate를 실패시킬 수 있습니다. 같은 cycle에 앞선 normal/resume가 있는데 cursor pair가 모두 NULL인 reset, coordination `updated_at > observedAt`, guarded `top_items` 비배열도 hard gate로 compile됐습니다. 고정 과거 observedAt 뒤에 현재 control row가 바뀐 재실행은 성공을 거부하므로 delayed replay를 현재 상태 증거로 오인하지 않습니다. 결과는 baseline10이라 `candidateSuccess=false`, setter 호출0입니다. commit별 excluded count는 현 ledger column이 NULL이라 snapshot JSON의 nonnegative integer까지만 검증하고 다른 출처와 동일하다고 과장하지 않습니다.
- 기본 `npm test`는 새 감사 test 4/4를 실행했지만 전체는 1074/1075로 exit1입니다. 실패1은 보호 대상 개인 일정의 `an automatic sync still uses the stored syncToken so routine runs stay cheap`이며 단독 실행도 같은 expected syncToken/actual full-window URL로 재현됩니다. 이번 N30 diff가 해당 파일을 수정하지 않았으므로 고치거나 PASS로 보고하지 않았습니다.
- 현재 HEAD 검증은 N30 관련 `node --test` 6파일 exit0, `check:server-contract` 71/71, `check:baseline` ok=true, `check:rank-feature-lock` 23함수·102파일·50migration PASS입니다. Production read-only transaction에서 candidate6·baseline canonical setter는 각각 `EXPLAIN ... WHERE false`, coordination row lock도 `EXPLAIN`으로만 compile했고 실제 함수는 호출하지 않았습니다. 최종 marker `n30_candidate6_transaction_template_dry_run_v1`은 `dry_run=true`, `setter_called=false`, fixture raw exact candidate/6=true, post baseline/10·processing0·idle=true, `transition_accepted=false`를 반환했습니다.
- `2026-08-25T05:19:03.127222Z` operations 재조회는 exact identity·heartbeat18.21초·last atomic27.21초·streak83·anchor 유지, baseline10/candidate false, closed/null, processing0와 lane/run/lease/stage/job/tracker/probe idle을 반환했습니다. `candidate_eligible=false`이며 모든 setter와 wake/cursor/order/quarantine/lease DML은0회입니다.
- 새 `naver-shopping-cadence-transition-sql` 회귀는 최초 생성기 부재 `ERR_MODULE_NOT_FOUND` RED, Production compile의 `pg_catalog.coalesce(boolean, boolean) does not exist` RED, postflight/GUC/role/atomic-proof 계약 RED를 거쳐 GREEN 6/6입니다. candidate는 exact current run/collection/last-success 없이는 생성되지 않고 malformed UUID·collection·timestamp를 거부합니다. candidate/baseline 모두 serializable·lock/statement timeout·service-role·coordination `FOR UPDATE`, setter 정확1회, raw/5개 transaction-local GUC, exact pre/post cadence·updated-at 범위·processing0·full idle·exception rollback을 포함합니다. candidate만 exact identity·fresh heartbeat·24시간·streak6·recent success와 ledger/snapshot atomic proof를 추가합니다.
- Production `BEGIN READ ONLY` compile probe v2는 실제 setter 대입을 fixture로 바꾸고 함수 참조는 `EXPLAIN ... WHERE false` 한 곳만 남겼다는 정적 guard(`refs=1`, executable setter=false) 뒤 실행했습니다. candidate와 baseline SQL 모두 compile됐고 실제 post는 baseline10이어서 `transitionAccepted=false`였습니다. 실제 최신 proof를 고정한 `n30_candidate6_atomic_gate_probe_v1`은 과잉 조건 때문에 `atomicProofOk=false`였으며, 분해 SELECT에서 group claim `06:00:00.661Z`·provenance start `06:00:00.775543Z`의 114ms 순서와 commit ledger `excluded_ad_count=NULL`·snapshot `excludedAdCount=30`을 확인했습니다. 기존 성공 RPC/성능 감사 계약에 맞춰 5초 bounded provenance 지연과 snapshot nonnegative excluded count로 수정한 v2는 같은 run의 `atomicProofOk=true`를 반환했습니다. coordination latest proof가 이미 다음 collection으로 전진해 `eligible=false`였으므로 stale proof가 전환을 통과하지 않았습니다.
- 1차 독립 SQL 감사에서 claim 일부집합만 보던 cross/NULL run, snapshot `EXISTS` 중복 허용, 비배열 `top_items` SRF 오류 가능성 P1 3건을 RED로 확인했습니다. 2차 감사의 run→claim orphan과 collection 시간창 밖 snapshot exactness P1도 RED로 고정했습니다. 최종 proof는 claim 전체 tracker/commit/failure, 같은 run의 다른/NULL claim terminal0, tracker/commit distinct set 일치, collection ID 전체 snapshot count=distinct tracker=count claim, tracker별 유효 snapshot 정확1, CASE 보호 numeric cast/SRF를 모두 요구합니다.
- 강화 뒤 Production `BEGIN READ ONLY` candidate/baseline 재컴파일은 정적 guard상 setter 참조 각1·모두 `EXPLAIN ... WHERE false`·실행 대입0입니다. candidate exact run `29a885d2-5e5e-46cb-adfb-930b0df8bcf4`, collection `pw-chrome-1787638209849-ee88bd2aa494efdd2569`, last-success `2026-08-25T06:10:10.547919Z`는 `atomicProofOk=true`였고 anchor24h 미충족으로 `eligible=false`, 실제 baseline10 post로 `transitionAccepted=false`였습니다. setter 호출·cadence 변경은0회입니다.
- 최종 실행값은 전환+성능 감사 10/10, 전환 생성기 파일 line/branch/function 100%, `check:baseline` ok=true, `check:server-contract` 71/71, `check:rank-feature-lock` 23함수·102파일·50migration, `node --check`, `git diff --check` PASS입니다. 전체 `npm test`는 1080/1081이고 실패1은 기존 개인 일정 `google-calendar-api.test.mjs:2256`의 expected syncToken/actual timeMin·timeMax입니다. 보호 범위는 수정하지 않았고 전체 suite PASS로 기록하지 않습니다. 독립 최종 재감사는 generator/test P0/P1 blocker0입니다. 후보 setter·baseline setter·wake/cursor/order/quarantine/lease DML은 모두0회입니다.
...
- activation 경로 재감사는 Production handler의 owner/primary-agency 검증 뒤 `supabaseAdmin.rpc('mi_set_naver_shopping_worker_cadence',{p_mode:'candidate'})` 호출과 exact accepted/activated/mode=candidate/minutes=8 검증을 확인했습니다. automation은 사용자 세션을 발명하지 않고 동일 canonical DB 함수의 service-controlled 단일 transaction에서 setter를 딱1회 호출하며, 외부 requestStart/responseEnd와 transaction-local startedAt/raw 및 같은 row lock 안의 post-state/idle 최종 resultset을 함께 캡처합니다. timeout·network·raw 결과 불완전은 committed-unknown으로 분류해 재호출하지 않고 DB 관측 상태도 raw 성공 응답을 대체하는 성공 증거로 쓰지 않습니다.
...
- event9895→9897 정시-compatible run은 직전 event9891과 `600.165초` 간격이고 group/tracker/commit 각1·failure0, claim→terminal `44.632초`입니다. collection `pw-chrome-1787584103628-9e58d3d5b78c0890a076` snapshot1은 checked300·official source·collection match·matched=false·organic policy/evidence·adExcluded·excluded30·top-item 위반0입니다. streak68→69, 동일 sort1500 cursor created_at `2026-07-08T05:01:48.647378Z`→`2026-08-14T06:49:16.159237Z` strict-forward, cycle36 group35=distinct35·duplicate0, tracker49=distinct49·duplicate0·commit49·failure0입니다. 잔여25그룹/27트래커 중 collectable22·격리3이며 processing/lane/run/lease/stage/job/tracker/probe null·closed/null·baseline10입니다.
- event9899→9901 정시-compatible run은 직전 정시 event9895와 `599.857초`, claim→terminal `41.420초`입니다. collection `pw-chrome-1787584700273-0084b4fe13bab7d133cd` snapshot1은 checked300·official source·collection match·matched=false·organic policy/evidence·adExcluded·excluded60·top-item 위반0입니다. streak69→70, cursor sort1500→1600, cycle36 group36=distinct36·tracker50=distinct50·commit50·failure/open0이고 terminal 뒤 lane/run/lease와 processing이 모두 해제됐습니다.
- event9903→9905는 wake requested/consumed `15:19:26.336Z`, updated `15:19:31.793Z`, claim `15:19:32.144Z`가 맞물리고 직전 정시 claim과 `113.291초`뿐이라 remote-wake 성능 제외 claim으로 고정했습니다. collection `pw-chrome-1787584814418-c0f724fea4e59720fc46` snapshot1은 checked300·official·collection match·organic/adExcluded·excluded45·top-item 위반0·rank18입니다. streak70→71, cycle group37/tracker51/commit51·중복/실패0, cursor sort1600→1700, terminal 뒤 lane 해제입니다.
- event9907→9909 정시-compatible run은 앞 정시 event9899와 `600.646초`, claim→terminal `42.207초`입니다. collection `pw-chrome-1787585301706-f9c593760f16ff31b7f4` snapshot1은 checked300·official·collection match·matched=false·organic policy/evidence·adExcluded·excluded45·top-item 위반0입니다. streak71→72, cycle36 group38=distinct claim/fingerprint38·tracker52=distinct52·commit52·failure/open0이며 `15:30:19Z` processing0·closed/null·lane/run/lease/stage/job/tracker/probe null·baseline10·candidate false입니다.
- 판정 SQL을 Production에 SELECT-only로 compile·실행했습니다. `activation_at=2026-08-24T14:16:03Z`, fixed observed `15:26:23.815705Z` 재현은 wall4220.815705초, raw group9/terminal9, scheduled-compatible7(bootstrap 뒤6), remote/early 제외2(event9872·9903), scheduled atomic7·violation/failure/cursor 역행0입니다. cycle36 `group37=distinct claim37=fingerprint37`, tracker51=distinct51·commit51·failure0이고 scheduled fixed-wall `5.970410`, remote 포함 raw `7.676241 group/hour`입니다. 이전 고정 `15:08:24Z`도 group7·scheduled6·tracker/commit8로 재현돼 join 증폭이 없습니다.
- 안전 측정 계약은 setter와 같은 transaction의 transaction-local 값으로 캡처한 immutable activation timestamp, 첫 동시대 wake 없음 자연 claim anchor, 동시대 확정 remote claim ID 목록, 480초 grid±120초, slot collision 제거, claim별 terminal 정확1·atomic snapshot, 최소60분·post-bootstrap6회입니다. coordination.updated_at은 heartbeat/claim/release로 drift하고 wake는 mutable 1행이므로 둘을 사후 activation/과거 wake 증거로 쓰지 않습니다. attribution이 불완전하면 fail-closed합니다.
- maxJobs1·8분 cadence는 장기 상한7.5 group/hour, 첫60분 bootstrap 포함 상한8.0이라 remote 제외 `>8.77`은 불가능합니다. 따라서 candidate8이 baseline10 순수 정시6보다 빨라도 기존 8.75~8.77 혼합 기준상 향상 성공으로 판정하지 않으며, 실측 미달은 baseline10 복귀 조건입니다.
- `15:33:03.749Z` partial `1114f3af…`는 quarantine 만료 뒤 `eligible_now=true`, pending1, processing null이지만 cycle36 claim/commit/failure0이었습니다. 다음 자연 selector는 임의 fallback 대신 cursor 뒤 tracker `f38473d3…`를 event9911→9913으로 처리했습니다. 앞 정시 claim과 `599.444초`, terminal `84.320초`, collection `pw-chrome-1787585943263-2fe23af7a8e89102fd49` snapshot1은 checked300·official·collection match·matched=false·organic policy/evidence·adExcluded·excluded45·top-item 위반0입니다. streak72→73, cursor sort1700→1800, cycle group39=distinct claim/fingerprint39·tracker53=distinct53·commit53·failure/open0이며 terminal 뒤 lane/run/lease null입니다. partial target은 eligible 상태에서 cycle claim/terminal0으로 보존됐습니다.
- 현재 코드·문서 상태에서 `npm run check:release`를 재실행해 core1025/1025·place51/51·shopping64/64·Production auth18/18, 보호 lock 23함수·100파일·49 migration, public build10파일·inline6·CSP hash4를 모두 exit0으로 통과했습니다.
...
- commit `e56337c0983921011037329da347e6103a13faba` push 뒤 `npx --no-install vercel --prod --yes`가 Production deployment `dpl_2MdDkmSN2FmNUb2u2XtoLcVQxW7z`를 Ready로 완료했습니다. alias `/health`는 HTTP200·release `e56337c09839`·live·icn1, `/ready`는 HTTP200·release 일치·Supabase ready·missingCount0이며 Vercel inspect도 target production·status Ready를 반환했습니다. 첫 `vercel --prod --yes`의 command-not-found는 배포 성공에서 제외했습니다.
- `2026-08-24T15:48:23.198283Z` 최신 SELECT-only 감사는 exact runtime1.1.12/fingerprint, heartbeat44.501초, anchor age10.2850h, streak74·baseline10·candidate false이고 anchor24h만 미충족입니다. event9915→9917은 앞 정시 claim과 `599.881초`, terminal `41.540초`, commit1/failure0입니다. collection `pw-chrome-1787586500364-b24f0ecfd696394dab90` snapshot1은 checked300·official·collection match·matched-aware organic·adExcluded·excluded30·top 위반0입니다. cycle36 group40=distinct40·tracker54=distinct54·commit54·failure0·중복0, cursor sort1800 created_at 순방향이고 processing0·closed/null·lane/run/lease/stage/job/tracker/probe null입니다. `1114f3af…`는 자연 만료됐지만 cycle claim/terminal/snapshot0, `12f5330a…`·`c0ccded2…`는 각각 `19:18:58.276397Z`·`2026-08-25T07:29:00.724542Z`까지 격리 중이며 수동 변경은0회입니다.
- rollback truthfulness TDD RED는 새 baseline exact-negative 회귀가 잘못된 `{accepted:true,activated:true,mode:candidate,minutes:10}`을 HTTP200으로 받으며 `200 !== 409`로 실패한 71/72와, 정적 server contract69/70 실패입니다. 최소 수정 뒤 같은 명령은 handler72/72·server contract70/70으로 GREEN이며 candidate exact8·owner-only·RPC fixed contract 회귀도 함께 통과했습니다. 보호 잠금과 self-test는 각각 23함수·100파일·49 migration PASS입니다. 사용자 지시에 따라 실패 테스트만의 checkpoint commit은 만들지 않고 GREEN 뒤에만 commit합니다.
- Production 함수 원문과 최신 migration은 global row `FOR UPDATE` 뒤 `clock_timestamp()`를 읽고 exact gate를 적용하지만 raw 응답에 activation timestamp가 없습니다. 따라서 gate용 단일 transaction은 외부 requestStart 직후 짧은 lock/statement timeout을 설정하고, transaction-local 값에 startedAt과 setter raw를 저장한 뒤 같은 transaction 최종 SELECT에서 raw·coordination.updated_at·candidate8 또는 baseline10·processing0·lane/run/lease/idle을 함께 반환합니다. row lock은 capture까지 heartbeat/claim 덮어쓰기를 막습니다. raw exact·updated_at 범위·post mode·post idle 중 하나라도 false거나 network/timeout이면 재호출 없이 성공0입니다.
- read-only connector 증거는 `16:20:21.927Z~16:20:23.542Z` 한 호출의 `BEGIN READ ONLY`·transaction-local GUC·final SELECT·trailing COMMIT 뒤 marker `n30_read_only_transaction_result_v1` 반환입니다. 이어 `16:23:05.849Z~16:23:08.384Z` 실제 template을 `EXPLAIN`·`WHERE false`로 compile해 marker `n30_candidate_template_dry_run_v1`, setter 미호출·transition/activation false·baseline10 불변을 확인했습니다.
- `16:40:15.481389Z` SELECT-only 운영 재검증은 exact identity, heartbeat43.694초, anchor age11.149523시간, streak80·baseline10·candidate false이며 anchor24h만 false입니다. 최신 event9941/run `f70c0131…`은 checked300·official·organic/adExcluded·top5 위반0입니다. cycle36 group46/46·tracker60/60·commit60, duplicate/failure/open/order 위반0, processing0·circuit closed·cooldown null·lane/run/lease/job/probe 완전 해제이며 setter/DML은0회입니다.
- GREEN 뒤 `node --experimental-test-coverage --test src/server/handlers/naver-rank-trackers.test.mjs`는 72/72 PASS이고 변경 대상 handler line coverage `81.00%`입니다(branch69.16%·functions78.01%; 함께 import된 전체 graph66.90%라 이를 전체 80%로 과장하지 않습니다). 현재 diff의 전체 `npm run check:release`는 core1025/1025·place51/51·shopping64/64·Production auth18/18, server contract70/70, 보호 lock23함수·100파일·49 migration, public build10파일·inline6·CSP hash4로 exit0입니다.
