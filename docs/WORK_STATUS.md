...
- 회귀 범위: 상품 N 30일 순위의 조회·광고 제외·원부/정확 상품 대표 판정은 변경하지 않았다. 전체 `check:release`는 API·서버 152/152, 플레이스 수집기 40/40, Production 인증 18/18, 서버 계약 22/22, 역할 parity·CSP 공개 빌드를 통과했고 독립 2차 검수에서 P0/P1 0건을 확인했다.
