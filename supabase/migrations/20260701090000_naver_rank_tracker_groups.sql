...
create index if not exists idx_naver_rank_trackers_agency_group_sort
on public.naver_rank_trackers(agency_code, group_name, sort_order asc, created_at desc);
