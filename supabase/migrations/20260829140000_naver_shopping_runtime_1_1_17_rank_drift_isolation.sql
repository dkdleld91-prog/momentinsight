-- Runtime 1.1.17 keeps stable-finite-window-v1 as the sanitized database
...
begin
  ...
  if coordination_found is not true
    ...
    or target.runtime_version is distinct from '1.1.16'
    or target.runtime_fingerprint is distinct from '9680164f90965609896b72c05b09e67946bc51d1df44c76d0cb5b9e5f0085478'
    ...
    raise exception 'naver_shopping_runtime_1_1_17_requires_idle_control_plane';
  end if;
end
$migration_guard$;
...
begin
  ...
  where tracker_id = 'c0ccded2-9bf7-488e-af8d-00898c0a1ff8'::uuid
    ...
    and runtime_fingerprint = '9680164f90965609896b72c05b09e67946bc51d1df44c76d0cb5b9e5f0085478';
  get diagnostics target_updated_count = row_count;

  if target_updated_count <> 1 then
    raise exception 'naver_shopping_runtime_1_1_17_target_mismatch';
  end if;
end
$target_transition$;
...
begin
  ...
  if coordination_updated_count <> 1 then
    raise exception 'naver_shopping_runtime_1_1_17_coordination_mismatch';
  end if;
end
...
begin
  ...
  if not found
    or target.runtime_version is distinct from '1.1.17'
...
begin
  ...
  eligible := coalesce((
    ...
    and target.runtime_version = '1.1.17'
