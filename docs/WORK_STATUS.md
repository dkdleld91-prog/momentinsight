...
- 로컬 대상 회귀 73/73, 전체 `check:release` 코어 629/629·플레이스 51/51·쇼핑 62/62·Production 인증 18/18, 공개 build CSP, 역할 상태·query parity, N30 보호 잠금 23함수·88파일·37 migration을 통과했습니다. 앱 브라우저가 localhost를 차단해 실제 렌더는 Production 반영 뒤 로그인 세션에서 별도 확인하며, 현재는 배포 전 후보입니다.
