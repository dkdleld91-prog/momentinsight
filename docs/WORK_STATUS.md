...
### 2026-08-25 N쇼핑 runtime1.1.13 candidate6·run provenance (Production·DB·Windows 반영, 첫 자연 atomic300 대기)
...
- `2026-08-24T17:50:12.716586Z` 운영 SELECT-only 교차검증은 Windows heartbeat age27.651초, runtime1.1.13·exact fingerprint, baseline10·anchor null·streak0·candidate false, circuit closed·reason/cooldown null, processing0·lane/run/lease/stage/job/tracker/probe 완전 idle입니다. provenance 표는 아직 0행이라 첫 자연 `rank-catch-up` atomic300은 미확인입니다. candidate setter와 wake/cursor/order/quarantine/lease 조작은 0회입니다.
