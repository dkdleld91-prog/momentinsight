...
const demoApiServer = read("src/server/handlers/demo-api.mjs");
...
const checks = {
  ...
  designedReportGenerator: adminSource.includes("data-report-kpi-input")
    && adminSource.includes("data-report-publish")
    && adminSource.includes("buildDesignedReportFromInput")
    && clientSource.includes("data-mi-designed-report")
    && clientSource.includes("data-mi-report-print")
    && demoApiServer.includes("const generatedReport = state.generatedReport")
    && demoApiServer.includes('.from("reports")')
    && demoApiServer.includes('visibility: "client_visible"'),
