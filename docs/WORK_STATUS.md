...
- `2026-08-24T18:26:33.870513Z`까지 provenance4행은 catch-up3·remote1이며 각 run이 group1·tracker claim1·commit1·failure0입니다. atomic commit/snapshot, run당 group, same-cycle group 중복, cursor 역행, 실행 겹침 위반은 모두0입니다. remote run은 정상 atomic 성공이지만 향후 scheduled 성능 분자에서 제외합니다. 운영은 streak4·baseline10·candidate false, heartbeat fresh, closed/null·processing0·lane/run/lease/stage/job/tracker/probe 해제입니다. 가장 이른 candidate 판정은 anchor+24시간인 `2026-08-25T17:58:36.220664Z` 이후이며 성공6회도 별도 충족해야 합니다. candidate setter와 wake/cursor/order/quarantine/lease 조작은0회입니다.
