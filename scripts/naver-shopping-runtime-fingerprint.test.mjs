...
test("calculates a deterministic version plus thirteen-component fingerprint", () => {
  const actual = calculateN30RuntimeFingerprint({ repositoryRoot: root, version: "1.1.18" });
  ...
  assert.equal(calculateN30RuntimeFingerprint({ repositoryRoot: root, version: "1.1.18" }).fingerprint, actual.fingerprint);
