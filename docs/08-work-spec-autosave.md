...
<!-- autosave:start -->
- 마지막 자동 저장: 2026. 06. 28. 00:16:51
- 기준 커밋: 6abff90
- 작업트리: M 02_아임웹_적용코드/복붙용_관리자형_CODE.txt /  M 02_아임웹_적용코드/아임웹_원샷코드_관리자형_모먼트인사이트.html /  M 03_운영시트_템플릿/build_moment_insight_sheet.mjs /  M 03_운영시트_템플릿/모먼트인사이트_운영시트_템플릿.xlsx /  M docs/08-work-spec-autosave.md /  M public/downloads/moment-insight-operation-sheet-template.xlsx /  M scripts/check-release-baseline.mjs
<!-- autosave:end -->
