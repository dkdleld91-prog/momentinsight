...
const checks = {
  ...
  seoEvaluationRoleParity: normalizedBlock(adminSource, "buildSeoEvaluation")
    ...
    && includesAll(adminSeoEvaluation, ["window.MomentSeoEvaluation", "auditPayload", "auditProduct", "signals.review", "signals.discount", "signals.reviewPoint", "signals.sellerTags", "signals.productNotice"])
    && includesAll(clientSeoEvaluation, ["window.MomentSeoEvaluation", "auditPayload", "auditProduct", "signals.review", "signals.discount", "signals.reviewPoint", "signals.sellerTags", "signals.productNotice"])
    ...
    && includesAll(adminSeoRender, ["상품명 키워드", "상품명 길이", "상위 리뷰 기준", "검색 태그", "현재 순위", "순위 "])
    && includesAll(clientSeoRender, ["상품명 키워드", "상품명 길이", "상위 리뷰 기준", "검색 태그", "현재 순위", "순위 "])
