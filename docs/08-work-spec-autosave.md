...
| 보류 | 네이버 API Hub 이관·쇼핑 검색 종료 대응 | 공식 메일·개발자센터 공지를 대조. Search Trend·Shopping Insight·일반 Search 일부는 Hub 이관 가능하지만 쇼핑 검색은 이관 제외·2026-07-31 종료·대체 API 없음. 현재 legacy 실호출 200으로 플레이스 장애와는 별개. 상품 단건·N 30일·SEO의 새 검증 소스와 Hub dual adapter를 분리 설계하고 기존 기록을 보존 | 공식 공지 32530·32564, API Hub 이관 가이드, 코드 호출 경로·환경변수·종료 후 영향 감사 | NCP Hub 앱·구독·키 및 상품 순위 대체 소스 확정 후 별도 구현·검증 |
