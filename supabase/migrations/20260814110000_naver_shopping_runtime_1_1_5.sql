...
-- Runtime 1.1.5 preserves authoritative same-page rank slots and isolates
-- strict partial windows to one tracker. Keep progress and cadence fail-closed
...
begin
  if p_run_id is null
    ...
    or trim(coalesce(p_runtime_version, '')) <> '1.1.5'
...
begin
  ...
  return jsonb_build_object(
    ...
    'candidate_eligible', coalesce((current_row.circuit_state = 'closed'
      ...
      and current_row.runtime_version = '1.1.5'
