...
-- Runtime 1.1.4 adds the range-v1 boundary collection handshake and bounded
-- suffix recovery. Keep progress and cadence fail-closed so an
...
begin
  if p_run_id is null
    ...
    or trim(coalesce(p_runtime_version, '')) <> '1.1.4'
...
begin
  ...
  return jsonb_build_object(
    ...
    'candidate_eligible', coalesce((current_row.circuit_state = 'closed'
      ...
      and current_row.runtime_version = '1.1.4'
