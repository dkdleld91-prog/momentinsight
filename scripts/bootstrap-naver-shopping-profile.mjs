...
const SEARCH_URL = "https://search.shopping.naver.com/search/all?where=all&frm=NVSCTAB&query=%EC%98%A8%EC%97%B4%EC%B0%9C%EC%A7%88%EA%B8%B0&pagingIndex=1&pagingSize=40&productSet=total&sort=rel&viewType=list";
