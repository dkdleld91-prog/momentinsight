...
- 상태: 상품 단건·30일 자동 추적·수동 갱신·Supabase 저장 전 경로에 광고 재검증 방어선을 추가. 네이버 실화면·실스냅샷·전체 품질검사 2회 통과, Production 배포 전
...
- 사용자 배포 승인: 광고 제외 오가닉 추적 정상화·실행 검증 완료 시 Production 배포 승인
