...
- 원자 `checkedCount=300`, 광고 제외, 실패 시 마지막 정상값 보존 계약은 변경하지 않았습니다. 대상 55/55, 앱·API 408/408, 전체 `npm run check:release`, 보호 잠금과 공개 CSP를 통과했습니다. Production과 Windows 설치본 반영을 진행합니다.
