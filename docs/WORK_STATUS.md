...
- native host 12/12, API·서버 397/397, 플레이스·쇼핑 각 51/51, 서버 계약 38/38, Production 인증 18/18, 보호 잠금 22함수·60파일·15마이그레이션과 전체 `npm run check:release`를 통과했습니다. Production·작업용 Mac 브리지 동기화는 배포 후 다시 확인합니다.
