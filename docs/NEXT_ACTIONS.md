...
5. 진행: anchor+24시간인 `2026-08-25T05:31:17.200373Z` 전까지 baseline10을 유지합니다. 2026-08-24 23:29 KST 기준 세 번째 post-migration atomic group까지 streak65·exact identity·closed/null·processing0·완전 idle이고, `candidate_eligible=false`의 유일한 미충족은 24시간입니다. 중간 remote-wake 회차는 향후 속도 표본에서 제외하며, 앞·뒤 정시 claim은 600.211초 간격입니다.
6. 진행: cycle36 roster60그룹 중 31그룹을 claim했고 잔여29 중 현재 eligible26·격리3입니다. 잔여 partial `1114…`·`12f5…`는 각각 event9676·9674에 quarantined roster로 포함돼 있으며 `2026-08-24T15:33:02.119249Z`·`19:18:58.276397Z` 자연 만료와 실제 fallback/다음-cycle 순번에서 회복 또는 typed failure를 확인합니다. 예상시각은 확정하지 않고 wake·cursor·순서·격리·lease를 수동 조작하지 않습니다.
