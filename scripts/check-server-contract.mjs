...
const files = {
  ...
  shoppingStableFiniteWindowRuntime1117Migration: "supabase/migrations/20260829140000_naver_shopping_runtime_1_1_17_rank_drift_isolation.sql",
  shoppingStableFiniteWindowRuntime1118Migration: "supabase/migrations/20260830064426_naver_shopping_runtime_1_1_18_rank_drift_diagnostics.sql",
  ...
  shoppingRenderedPageToleranceRuntime1123Migration: "supabase/migrations/20260911090000_naver_shopping_runtime_1_1_23_rendered_page_tolerance.sql",
  shoppingFailureEvidenceRuntime1124Migration: "supabase/migrations/20260911120000_naver_shopping_runtime_1_1_24_failure_evidence.sql",
  shoppingRenderedIdentityRuntime1125Migration: "supabase/migrations/20260911170000_naver_shopping_runtime_1_1_25_rendered_identity.sql",
  ...
  shoppingFiniteDriftEvidenceRuntime1130Migration: "supabase/migrations/20260913150000_naver_shopping_runtime_1_1_30_finite_drift_evidence.sql",
...
const shoppingStableFiniteWindowRuntime1117Migration = fs.readFileSync(files.shoppingStableFiniteWindowRuntime1117Migration, "utf8");
const shoppingStableFiniteWindowRuntime1118Migration = fs.readFileSync(files.shoppingStableFiniteWindowRuntime1118Migration, "utf8");
...
const shoppingRenderedPageToleranceRuntime1123Migration = fs.readFileSync(files.shoppingRenderedPageToleranceRuntime1123Migration, "utf8");
const shoppingFailureEvidenceRuntime1124Migration = fs.readFileSync(files.shoppingFailureEvidenceRuntime1124Migration, "utf8");
const shoppingRenderedIdentityRuntime1125Migration = fs.readFileSync(files.shoppingRenderedIdentityRuntime1125Migration, "utf8");
...
const shoppingFiniteDriftEvidenceRuntime1130Migration = fs.readFileSync(files.shoppingFiniteDriftEvidenceRuntime1130Migration, "utf8");
...
check(
  "N Shopping runtime 1.1.21 generalizes the proven finite commit and keeps exact-parent identity",
  hasAll(shoppingStableFiniteWindowMigration, [
    ...
    && shoppingNextDataSchemaDriftRecoveryMigration.includes(
    ...
    && hasAll(shoppingStableFiniteWindowRuntime1117Migration, [
      /target\.runtime_version is distinct from '1\.1\.16'/,
      /9680164f90965609896b72c05b09e67946bc51d1df44c76d0cb5b9e5f0085478/,
    ...
    && hasAll(shoppingStableFiniteWindowRuntime1118Migration, [
      /current_row\.runtime_version is distinct from '1\.1\.17'/,
      /set runtime_version = '1\.1\.18'/,
      /target_updated_count <> prior_target_count/,
    ...
    && hasAll(shoppingStableRenderedOrderRuntime1119Migration, [
      /current_row\.runtime_version is distinct from '1\.1\.18'/,
    ...
    && hasAll(shoppingRenderedBoundaryConsensusRuntime1120Migration, [
      /current_row\.runtime_version is distinct from '1\.1\.19'/,
      /set runtime_version = '1\.1\.20'/,
      /expected_runtime_version constant text := '1\.1\.20'/,
      /naver_shopping_runtime_1_1_20_requires_completed_account_priority/,
      /security invoker/,
      /set search_path = ''/,
      /from public, anon, authenticated, service_role/,
      /to service_role/,
    ...
    && hasAll(shoppingFiniteGeneralRuntime1121Migration, [
      /current_row\.runtime_version is distinct from '1\.1\.20'/,
      ...
      /create or replace function mi_internal\.mi_guard_naver_shopping_exact_parent_snapshot\(\)/,
      /naver_shopping_scheduler_events_finite_window_committed_check/,
      /security invoker/,
      /set search_path = ''/,
      /from public, anon, authenticated, service_role/,
      /to service_role/,
    ])
    && !/create or replace function public\.mi_commit_naver_shopping_worker_result\(/.test(shoppingFiniteGeneralRuntime1121Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingRenderedPageToleranceRuntime1123Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingFailureEvidenceRuntime1124Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingRenderedIdentityRuntime1125Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingRenderedIdentityFallbackRuntime1126Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingSamePageTwinsRuntime1127Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingFiniteDriftEvidenceRuntime1130Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingEvidenceV2ThirdPassRuntime1131Migration)
    ...
    && !/create or replace function public\.mi_commit_naver_shopping_(?:finite_)?worker_result\(/.test(shoppingFiniteCrossPageRuntime1132Migration)
  ...
  `${files.shoppingStableFiniteWindowMigration}, ${files.shoppingStableFiniteWindowRuntime1115Migration}, ${files.shoppingExactParentRelationGuardMigration}, ${files.shoppingStableFiniteWindowRuntime1116Migration}, ${files.shoppingStableFiniteWindowRuntime1117Migration}, ${files.shoppingStableFiniteWindowRuntime1118Migration}, ${files.shoppingStableRenderedOrderRuntime1119Migration}, ${files.shoppingRenderedBoundaryConsensusRuntime1120Migration}, ${files.shoppingFiniteGeneralRuntime1121Migration}, ${files.shoppingNextDataSchemaDriftRecoveryMigration}, ${files.shoppingSupersavingCompositeRecoveryMigration}`,
);
check(
...
check(
  ...
  shoppingChromeManifest.version === "1.1.32"
    ...
    && /const EXPECTED_RUNTIME_VERSION = "1\.1\.32";/.test(shoppingLocalWorker)
    && /const EXPECTED_WORKER_RUNTIME_VERSION = "1\.1\.32";/.test(shoppingLocalWorkerHandler)
    && /const SHOPPING_WORKER_EXPECTED_RUNTIME_VERSION = "1\.1\.32";/.test(productTrackers)
