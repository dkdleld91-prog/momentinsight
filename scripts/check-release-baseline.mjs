...
const shoppingWorkerRuntime1124Fingerprint = calculateN30RuntimeFingerprint({
...
const checks = {
  ...
  shoppingRemoteWakeIsAtomicAndOneJobBounded: shoppingChromeManifest.version === "1.1.24"
    ...
    && shoppingLocalWorker.includes('const EXPECTED_RUNTIME_VERSION = "1.1.24";')
    && shoppingLocalWorkerHandler.includes('const EXPECTED_WORKER_RUNTIME_VERSION = "1.1.24";')
    && rankServer.includes('const SHOPPING_WORKER_EXPECTED_RUNTIME_VERSION = "1.1.24";')
  ...
  shoppingRuntime1116ExactParentProofExactIdentity:
    ...
    && shoppingCandidatePerformanceAudit.includes('export const N30_TARGET_RUNTIME_VERSION = "1.1.24";')
    && shoppingCandidatePerformanceAudit.includes(shoppingWorkerRuntime1124Fingerprint)
  ...
  migrationsCarryNoRuntimeLiteralsOutsideAllowlist: migrationRuntimeLiteralAudit.ok
    ...
    && migrationRuntimeLiteralAudit.carriers[0].fingerprints
      .includes(shoppingWorkerRuntime1124Fingerprint),
  ...
  shoppingManualExtensionQueuesEntireTrackerSite: shoppingChromeManifest.version === "1.1.24"
    && shoppingChromeWorker.includes('port.postMessage({ action: "run", trigger, ...runtimeIdentity })')
