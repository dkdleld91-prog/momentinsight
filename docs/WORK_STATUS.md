...
- macOS LaunchAgent가 매일 08:50·14:50 KST에 승인된 `/Users/sindongbin/Desktop/Google Chrome.app`의 `Default(동빈)` 프로필만 준비한다. 확장 프로그램은 09:00·15:00 정규 실행과 매시 미처리 보정을 유지한다.
