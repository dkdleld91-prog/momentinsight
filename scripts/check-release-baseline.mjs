...
const checks = {
  ...
  shoppingRemoteWakeIsAtomicAndOneJobBounded: shoppingChromeManifest.version === "1.0.34"
  ...
  shoppingManualExtensionQueuesEntireTrackerSite: shoppingChromeManifest.version === "1.0.34"
