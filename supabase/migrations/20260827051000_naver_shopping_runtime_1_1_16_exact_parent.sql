-- Runtime 1.1.16 keeps stable-finite-window-v1 as the sanitized database
...
begin
  ...
  if coordination_found is not true
    ...
    or target.runtime_fingerprint is distinct from 'c7941930ccabd1206f19cc9ae5cfcd744f12313974c37d5143ed5f795ec9b46c'
    ...
    raise exception 'naver_shopping_runtime_1_1_16_requires_idle_control_plane';
  end if;
end
$migration_guard$;
...
begin
  ...
  if target_updated_count <> 1 then
    raise exception 'naver_shopping_runtime_1_1_16_target_mismatch';
  end if;
end
$target_transition$;
...
begin
  ...
  eligible := coalesce((
    ...
    and target.runtime_version = '1.1.16'
