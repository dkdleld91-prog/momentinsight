...
5. 진행: anchor+24시간인 `2026-08-25T05:31:17.200373Z` 전까지 baseline10을 유지합니다. 2026-08-24 23:24 KST 기준 두 번째 post-migration atomic300까지 streak64·exact identity·closed/null·processing0·완전 idle이고, `candidate_eligible=false`의 유일한 미충족은 24시간입니다. 두 번째 회차는 remote-wake handoff 증거가 있어 향후 scheduled-compatible 성능 표본에서 제외합니다.
