...
- 상태: 상품 단건·30일 자동 추적·수동 갱신·Supabase 저장 전 경로에 광고 재검증 방어선을 추가. 네이버 실화면·실스냅샷·전체 품질검사 2회·운영 재검증 후 Production 배포 완료
...
- 사용자 배포 승인: 광고 제외 오가닉 추적 정상화·실행 검증 조건을 충족해 Production 배포와 운영 재검증 완료
