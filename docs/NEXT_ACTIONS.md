...
7. 진행: DB anchor는 `2026-08-24T17:58:36.220664Z`로 유지됐습니다. 잔여 `1114f3af…`은 자연 순번에서 `provider_partial_window:30_300` typed failure로 유한 종료·24시간 격리됐고 부분 snapshot0·기존 이력 보존을 확인했습니다. 뒤이은 grouped run은 tracker2 모두 official atomic300으로 끝나 현재 provenance6(catch-up5·remote1), streak5, same-cycle 중복·overlap·lane 위반0입니다. remote1과 typed failure는 향후 성능 분자에서 제외합니다. 가장 이른 candidate 판정은 `2026-08-25T17:58:36.220664Z` 이후이며 anchor+24시간·새 성공6회와 exact identity·fresh heartbeat·recent atomic300·closed/null·processing0·완전 idle 전에는 setter를 호출하지 않습니다.
