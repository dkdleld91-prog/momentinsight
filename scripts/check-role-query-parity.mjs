...
const checks = {
  ...
  seoEvaluationRoleParity: normalizedBlock(adminSource, "buildSeoEvaluation")
    ...
    && includesAll(adminSeoEvaluation, ["window.MomentSeoEvaluation", "rankResult.exactItem", "peerCategories", "peerTitles", "productInfoVerified", "reviewCount: input.reviewCount", 'auditSource: "naver_shopping_official_result"'])
    && includesAll(clientSeoEvaluation, ["window.MomentSeoEvaluation", "rankResult.exactItem", "peerCategories", "peerTitles", "productInfoVerified", "reviewCount: input.reviewCount", 'auditSource: "naver_shopping_official_result"'])
    && !adminSeoEvaluation.includes("productKindLabel")
    && !clientSeoEvaluation.includes("productKindLabel")
