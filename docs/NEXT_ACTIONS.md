...
5. 진행: anchor+24시간인 `2026-08-25T05:31:17.200373Z` 전까지 baseline10을 유지합니다. 2026-08-24 23:49 KST 기준 다섯 번째 post-migration atomic group까지 streak67·exact identity·closed/null·processing0·완전 idle이고, `candidate_eligible=false`의 유일한 미충족은 24시간입니다. remote-wake 회차는 향후 속도 표본에서 제외하며 최근 연속 정시 claim 간격은 600.211·599.934·600.398초입니다.
