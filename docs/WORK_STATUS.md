...
- 배포가 성공하면 proof는 baseline10·anchor null·streak0부터 다시 시작합니다. 첫 자연 official atomic300 뒤 24시간·6회와 모든 exact/idle gate를 충족해야 candidate6를 총1회 전환하며, 이후 120분 이상·post-bootstrap `rank-catch-up` 18그룹 이상의 fixed-wall 실측이 8.77그룹/시간을 초과할 때만 속도 향상 완료입니다. 불확실하거나 미달이면 baseline10 1회 복귀·성공0입니다.
